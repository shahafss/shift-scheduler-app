...
export const EmployeeListItem = defineComponent({
	...
	props: {
		...
		onClick: {type: Function as PropType<(employee: Employee) => void>, required: true},
	...
	setup(props) {
		...
		return () => {
			...
			return (
				<div class={[employeeStyle, isSelected && employeeSelectedStyle]}
					onClick={() => onClick(employee)}>
					{isSelected && <button onClick={() => onDeleteClick()} class={deleteButtonStyle}>X</button>}
					{employee.name}
				</div>
			)
		}
